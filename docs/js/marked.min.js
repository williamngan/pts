...
!(function (e) {
  ...
  ((t._label = /(?!\s*\])(?:\\[\[\]]|[^\[\]])+/),
    ...
    (t.bullet = /(?:[*+-]|\d+\.)/),
    (t.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/),
    (t.item = p(t.item, "gm").replace(/bull/g, t.bullet).getRegex()),
    (t.list = p(t.list)
  ...
  ((r._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    ...
    (r.link = p(r.link)
      ...
      .getRegex()),
    (r.reflink = p(r.reflink).replace("label", r._label).getRegex()),
    (r.normal = f({}, r)),
    ...
    (l.prototype.strong =
      l.prototype.em =
      l.prototype.codespan =
      l.prototype.del =
      l.prototype.text =
        function (e) {
          return e;
        }),
    (l.prototype.link = l.prototype.image =
      function (e, t, n) {
        return "" + n;
      }),
