...
//#endregion
//#region src/Op.ts
	var Op_exports = /* @__PURE__ */ __exportAll({
		Circle: () => Circle,
		Curve: () => Curve,
		Line: () => Line,
		Polygon: () => Polygon,
...
//#region src/LinearAlgebra.ts
	var LinearAlgebra_exports = /* @__PURE__ */ __exportAll({
		Mat: () => Mat,
		Vec: () => Vec
	});
	var Vec = class Vec {
...
//#endregion
//#region src/Num.ts
	var Num_exports = /* @__PURE__ */ __exportAll({
		Geom: () => Geom,
		Num: () => Num,
		Range: () => Range,
		Shaping: () => Shaping
...
//#endregion
//#region src/Pt.ts
	var Pt_exports = /* @__PURE__ */ __exportAll({
		Bound: () => Bound,
		Group: () => Group,
		Pt: () => Pt
	});
...
//#endregion
//#region src/Image.ts
	var Image_exports = /* @__PURE__ */ __exportAll({ Img: () => Img });
	var Img = class Img {
	...
	var Delaunay = class extends Group {
		...
		delaunay(triangleOnly = true) {
			...
			for (let t = 0, len = indices.length; t < len; t += 3) {
				...
				const [ccx, ccy, r] = _circumcircle(coords[2 * i], coords[2 * i + 1], coords[2 * j], coords[2 * j + 1], coords[2 * k], coords[2 * k + 1]);
		...
		_ensureMesh() {
			if (!this._meshBuilt) {
				...
				if (this._shapes) for (let s = 0, len = this._shapes.length; s < len; s++) this._cache(this._shapes[s]);
			}
			return this._mesh;
		}
		voronoi(bound) {
...
//#endregion
//#region src/Color.ts
	var Color_exports = /* @__PURE__ */ __exportAll({ Color: () => Color });
...
//#endregion
//#region src/Play.ts
	var Play_exports = /* @__PURE__ */ __exportAll({
		Sound: () => Sound,
		Tempo: () => Tempo
	});
...
//#endregion
//#region src/_script.ts
	globalThis.Pts = _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, Canvas_exports), Create_exports), Form_exports), LinearAlgebra_exports), Num_exports), Op_exports), Pt_exports), Space_exports), Color_exports), Util_exports), Dom_exports), Svg_exports), Typography_exports), Physics_exports), UI_exports), Play_exports), Image_exports);
	globalThis.Pts.namespace = (scope) => {
		let lib = globalThis.Pts;
		for (let k in lib) if (k != "namespace") scope[k] = lib[k];
	};
