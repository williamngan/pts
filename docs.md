...
Complete API reference for [Pts 1.0.0](https://ptsjs.org), generated from the same TypeDoc data used by the documentation website. Members are documented in full where they are declared and linked from subclasses that inherit them. For tutorials and runnable examples, see the [Pts guides and demos](https://ptsjs.org/guide.md).
