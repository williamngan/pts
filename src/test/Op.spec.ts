...
describe("Op: ", function () {
  describe("Line: ", function () {
    ...
    it("can find Pt on a line that is perpendicular to a target Pt", function () {
      ...
      assert.isTrue(
        Num.equals(Line.distanceFromPt(ln, [392, 446]), 47.356164440736634),
      );
    });

    it("can check 2D ray intersection", function () {
      let r1 = Group.fromArray([
        [5, 4.5],
        [10, 2],
      ]);
      let r2 = Group.fromArray([
        [0, 3],
        [-4, -5],
      ]);
    ...
    it("can check 2D line segment intersection", function () {
      ...
      assert.isTrue(
        Line.intersectLine2D(r1, r2).equals([21.81818181, 58.1818199], 0.00001),
      );
    });
  ...
  describe("Polygon: ", function () {
    ...
    it("can calculate perimeter of a polygon", function () {
      ...
      assert.isTrue(
        Num.equals(Polygon.perimeter(g, true).total, 20.789, 0.001),
      );
    });
  });
});
