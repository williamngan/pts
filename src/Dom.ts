...
export class DOMSpace extends MultiTouchSpace {
  ...
  */
   ...
   */
  static domElement( parent:Element, name:string, id?:string, autoClass:boolean=true ):SVGElement {
 ...
 */
export class DOMForm extends VisualForm {
  ...
  */
  ...
  arc( pt:PtLike, radius:number, startAngle:number, endAngle:number, cc?:boolean ):this {
    Util.warn( "arc is not implemented in DOMForm" );
    return this;
  }
  ...
  line( pts:GroupLike|number[][] ):this {
    Util.warn( "line is not implemented in DOMForm" );
    return this;
  }
  ...
  polygon( pts:GroupLike|number[][] ):this {
    Util.warn( "polygon is not implemented in DOMForm" );
    return this;
  }
}
...
export class SVGSpace extends DOMSpace {
  ...
  */
   ...
   * @param id id string
   */
  createElement( elem:string="svg", id:string ):Element {
