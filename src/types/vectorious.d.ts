...
export class Vector {
     ...
     **/
    public project (vector: Vector): this;
     ...
     **/
    public combine (vector: Vector): this;
     ...
     * @returns {Vector} `this`
     **/
    public map (callback: (element: number) => number): this;
     ...
     * @returns {Vector} `this`
     **/
    public each (callback: (element: number) => void): this;
...
export class Matrix {
     ...
     * @returns {Matrix} `this`
     **/
    public product (matrix: Matrix): this;
     ...
     **/
    public lusolve (rhs: Matrix, ipiv: Int32Array): this;
     ...
     **/
    public solve (rhs: Matrix|Vector): this;
     ...
     * @returns {Matrix} `this`
     **/
    public augment (matrix: Matrix): this;
