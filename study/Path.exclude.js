...
window.demoDescription = "Path.exclude keeps the area inside an odd number of shapes, so every overlap becomes a hole. Drag the disc across the star and the turning rectangle.";
