...
window.demoDescription = "Path.minusBack subtracts the shapes behind from the frontmost one: the disc under the pointer minus the star and the turning rectangle. Drag the disc across them to carve it.";
