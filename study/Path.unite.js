...
window.demoDescription = "Path.unite merges every shape into one polygon: the area inside any of them. Move the pointer to drag the disc over the star and the turning rectangle; where nothing overlaps, the shapes stay separate rings.";
