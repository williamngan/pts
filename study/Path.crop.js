...
window.demoDescription = "Path.crop uses the frontmost shape as a mask: the disc under the pointer. Only the faces of the star and the turning rectangle inside the disc remain, and the disc itself is discarded.";
