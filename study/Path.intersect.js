...
window.demoDescription = "Path.intersect keeps only the area inside every shape. Drag the disc over where the star and the turning rectangle overlap to see the common area; anywhere else the result is empty.";
